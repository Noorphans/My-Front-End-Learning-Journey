...
* **函数声明时，小括号里的是形参，形式上的参数 可理解为变量**

* 形式上的参数-声明函数时写在函数名右边小括号里的叫形参

* **形参可以理解为**是在这个函数内声明的**变量**（比如num1=10）
...
* **函数调用时，小括号里的是实参，实际上的参数 可理解为赋值**

* 实际上的参数-调用函数时写在函数名右边小括号里的叫实参
...
* **形参**：可以看做变量，但如果一个变量**不给值则默认是undefined**
